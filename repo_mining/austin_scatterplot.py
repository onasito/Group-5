...
# convert to date-time object for easier subtraction later 
repo_creation_date = datetime(2015, 6, 19)
...
# In the example on website, it's intervals of 50, but I made it so it's easier to see on scatter plot 
